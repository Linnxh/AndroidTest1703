 ...
 * 富文本字符串
 */
public class SpannActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_spann);

        TextView tv_span = (TextView) findViewById(R.id.tv_span);
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Toast.makeText(SpannActivity.this, "点击", Toast.LENGTH_SHORT).show();
            }
        ...
        tv_span1.setMovementMethod(LinkMovementMethod.getInstance());
        // 点击背景色
        // spanString.setHighlightColor(Color.parseColor("#36969696"));
        // 可以点击
        tv_span1.setText(spannableString);
